...
<html lang="ko">
  ...
  <body>
	...
	<div class="container">
		<form action="updatefreePro.do" onsubmit="return writeSave()" method = "post">
			...
			<input type = "button" class="btn" value = "목록보기" onclick="location.href='listfree.do?pageNum=${pageNum}'"> 
		</table>
