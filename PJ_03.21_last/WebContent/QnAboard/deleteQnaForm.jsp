...
<body>
	...
	<div class="container">
		<div align="center">
			<h2>글 삭제</h2>
			<form action="deleteQnaPro.do" method="post" name="delForm"
				onsubmit="return ask()">
				<table class="table" style="width:400px; padding:30px;">
					<tr height="30">
						<th>비밀번호</th>
					...
					<tr height="30">
						...
						<td align="center"><input type="submit" class="btn" value="글삭제">
